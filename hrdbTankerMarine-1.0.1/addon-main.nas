...
var main = func(addon) {
  ...
  # add tanker to the list
  var tankers = props.globals.getNode("/sim/ai/tankers/");
  var my_tanker = {
    'name': 'Rafale buddy-buddy',
    'type': 'probe',
    'model': 'AI/Aircraft/dassault-rafale-M/dassault-rafale-M.xml',
    'speed-kts': 250,
    'max-fuel-transfer-lbs-min': 2000,
    'contact': {
      'x-m': -15,
      'z-m': -2,
    }
  };
  var node_tanker = tankers.addChild("tanker");
  node_tanker.setValues(my_tanker);
}
